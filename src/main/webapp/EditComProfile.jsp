...
<html>
    ...
    <body style="margin:0px" bgcolor="#FFFFFF">
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select CName,CAddress,CPost,CCriteria,CEmail,CContact,CCutoff,ACutoff,lastdate from Com where CUsername='" + c1 + "'");
            String a = null;
            String b = null;
            String c = null;
            String d = null;
            ...
            while (rs.next())
            {
				...
				h= rs.getString("ACutoff");
                i = rs.getString("lastdate");
                    ...
                    <div class="Reg" align="center">
                        <form method="POST" action="savecompanyedit.jsp" name="form1" onSubmit="return check()">
                            <table width =66% border=0 cellpadding=3 cellspacing=0 bordercolor="#FFFFFF" >
                                ...
                                <tr  bgcolor =#FEF7E9>
                                    <td bgcolor="#D9DEE6">
                                    <div align="center"><font SIZE="2" COLOR="black" face =arial>Educational CutOff %</font></div></td>
                                    <td bgcolor="#D9DEE6">
                                        <div align="left">
							...
							<tr  bgcolor =#FEF7E9>
                                <td bgcolor="#E6F0F0"><div align="left"><font SIZE="2" COLOR="black" face =arial>Aptitude CutOff %</font></div></td>
                                <td bgcolor="#E6F0F0"><div align="left">
                                        <input TYPE="text" NAME="acutoff" id="acutoff" size=30 maxlength=30 value="<%=h%>">
                                </div></td>
                            </tr>
							<tr>
                                <td bgcolor="#FFFFFF"><div align="left"><font SIZE="2" COLOR="black" face =arial>Last date (for candidate application):</font></div></td>
                                <td bgcolor="#FFFFFF"><div align="left">
                                        <input TYPE="text" NAME="lastdate" id="lastdate" size=10 maxlength=10 value="<%=i%>" >
