...
<form enctype="multipart/form-data" class="formoid-solid-light-green" style="background-color:#1A2223;font-size:17px;font-family:'Palatino Linotype','Book Antiqua',Palatino,serif;color:#34495E;max-width:500px;min-width:150px" action="dismailres.jsp" method="post"><div class="title"><h2>Mail to</h2></div>
