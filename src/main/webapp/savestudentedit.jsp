...
<html>
 ...
 String a = "Update details set Name='" + name + "',CollegeName='" + college +"',CollegePhone='" + coph + "',CollegeEmail='" + cemail + "',Mark='" + degree + "',Email_id='" + email + "',Telephone='" + ph + "',Address='" + add + "',State='" + state +"',Pincode='" + pin + "',Category='" + new_cat + "' where Username='" + c1 + "'";
            st.executeUpdate(a);
            String q = null;
